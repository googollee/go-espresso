...
type AuthWithAkSk[User any] struct {
	bear string
	f    func(ctx context.Context, ak, sk string) (User, error)
	util middleware.Middleware[User]
}

func NewAuthWithAkSk[User any](bear string, f func(ctx context.Context, ak, sk string) (User, error)) *AuthWithAkSk[User] {
